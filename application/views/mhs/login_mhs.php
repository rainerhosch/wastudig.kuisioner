...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="<?php echo base_url('Login'); ?>"><b>E-Survey</b><br>Penilaian Kinerja Dosen</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
      <p class="login-box-msg"><b>Login Mahasiswa</b><br>Sign in to start your session</p>

      <form method="post" action="<?php echo base_url('Kuisioner/proses_login_mhs'); ?>">
        ...
        $.ajax({
          ...
          success: function(i) {
            if (i == 'true') {
              ...
              window.location.replace("<?= base_url('Dashboard_user/dashboard_mhs') ?>");
            } else {
              new PNotify({
                title: 'Gagal',
