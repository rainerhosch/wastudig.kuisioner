    ...
    <section class="content">
        ...
        <div class="box box-warning">
            ...
            <div class="box-header with-border">
                <div class="col-md-6">
                    <h2 style="margin-top:0px">Tambah Catatan</h2>
                </div>
                <?php
                    echo form_open('Catatan/input_action');
                ?>
            </div>
            <!-- /.box-header -->
            <!-- box body -->
            ...
            <form method="post" id="form_catatan" class="form-horizontal">
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-14">
                    <textarea id="textarea" name="catatan" placeholder="Enter text ..." style="width: 1040px" required="true"></textarea>
