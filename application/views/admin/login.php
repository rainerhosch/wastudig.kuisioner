...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('assets/backend/pnotify/dist/pnotify.css') ?>">
  <link rel="stylesheet" href="<?= base_url('assets/backend/pnotify/dist/pnotify.buttons.css') ?>">
  <link rel="stylesheet" href="<?= base_url('assets/backend/pnotify/dist/pnotify.nonblock.css') ?>">
...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="<?= base_url(); ?>"><b>E-Survey</b><br>Penilaian Kinerja Dosen</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
      <p class="login-box-msg">Sign in to start your session</p>

      <form method="post" action="<?= base_url('kuisioner/proses_login_admin'); ?>">
  ...
  <!-- PNotify -->
  <script src="<?= base_url('assets/backend/pnotify/dist/pnotify.js') ?>"></script>
  <script src="<?= base_url('assets/backend/pnotify/dist/pnotify.buttons.js') ?>"></script>
  <script src="<?= base_url('assets/backend/pnotify/dist/pnotify.nonblock.js') ?>"></script>
        ...
        $.ajax({
          ...
          success: function(i) {
            if (i == 'true') {
              ...
              window.location.replace("<?= base_url('Kuisioner/dashboard') ?>");
            } else {
              new PNotify({
                title: 'Gagal',
